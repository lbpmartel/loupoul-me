...
keywords:
  ...
  - "dom testing library"
  - "async"
banner: "https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032606/kentcdodds.com/content/blog/common-mistakes-with-react-testing-library/banner.jpg"
bannerCredit: "Photo by [Sarah Kilian](https://unsplash.com/photos/52jRtc2S_VE)"
---

Traductions libres présentement disponibles :

- [Portugais brésilien](https://giovanisleite.dev/erros-comuns-com-react-testing-library)
- [Coréen](https://seongry.github.io/2021/06-20-common-mistakes-with-rty/)
...
(ce qui veut dire que vous y avez acces avec `@testing-library/react@>=9`). Ça vient su même import que celui pour lequel on obtient `render` :
